...
abstract class BaseFragment<T : ViewBinding>(
    ...
    companion object {
        /** Global cache for bindings across fragment instances. */
        private val bindingCache = ConcurrentHashMap<String, WeakReference<ViewBinding>>()

        /** Limited-size binding pool per fragment type for reuse (up to 3). */
        private val bindingPool = ConcurrentHashMap<String, CopyOnWriteArrayList<WeakReference<ViewBinding>>>()
    }
