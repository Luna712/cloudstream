...
object OfflinePlaybackHelper {
     ...
     * keeping the stack flat (at most one player at a time). This prevents the
     * ViewModel / generator cache accumulation that causes OOM when many files
     * are opened in sequence via DownloadedPlayerActivity.
     */
