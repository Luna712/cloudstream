...
object Torrent {
    ...
    data class TorrentStatus(
        ...
        @SerialName("stat_string") var statString: String,
        @SerialName("loaded_size") var loadedSize: Long?,
        @SerialName("torrent_size") var torrentSize: Long?,
        @SerialName("preloaded_bytes") var preloadedBytes: Long?,
        @SerialName("preload_size") var preloadSize: Long?,
        @SerialName("download_speed") var downloadSpeed: Double?,
        @SerialName("upload_speed") var uploadSpeed: Double?,
        @SerialName("total_peers") var totalPeers: Int?,
        @SerialName("pending_peers") var pendingPeers: Int?,
        @SerialName("active_peers") var activePeers: Int?,
        @SerialName("connected_seeders") var connectedSeeders: Int?,
        @SerialName("half_open_peers") var halfOpenPeers: Int?,
        @SerialName("bytes_written") var bytesWritten: Long?,
        @SerialName("bytes_written_data") var bytesWrittenData: Long?,
        @SerialName("bytes_read") var bytesRead: Long?,
        @SerialName("bytes_read_data") var bytesReadData: Long?,
        @SerialName("bytes_read_useful_data") var bytesReadUsefulData: Long?,
        @SerialName("chunks_written") var chunksWritten: Long?,
        @SerialName("chunks_read") var chunksRead: Long?,
        @SerialName("chunks_read_useful") var chunksReadUseful: Long?,
        @SerialName("chunks_read_wasted") var chunksReadWasted: Long?,
        @SerialName("pieces_dirtied_good") var piecesDirtiedGood: Long?,
        @SerialName("pieces_dirtied_bad") var piecesDirtiedBad: Long?,
        @SerialName("duration_seconds") var durationSeconds: Double?,
        @SerialName("bit_rate") var bitRate: String?,
        @SerialName("file_stats") var fileStats: List<TorrentFileStat>?,
